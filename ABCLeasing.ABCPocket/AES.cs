...
namespace ABCLeasing.ABCPocket
{
    public class AES
    {
        #region Properties
        private static string passphrase = "{{}my1Z=6$'wI@G";
        #endregion
        #region Class
        #endregion
        #region Methods
        ...
        public string OpenSSLEncrypt(string plainText)
        {
            ...
            //            string result = Convert.ToBase64String(encryptedBytesWithSalt);
        ...
        public string OpenSSLDecrypt(string encrypted)
        {
            ...
            byte[] key, iv;
            DeriveKeyAndIV(passphrase, salt, out key, out iv);
            //string result = DecryptStringFromBytesAes(encryptedBytes, key, iv);
