select
	...
	IND.TVA RFC,
    tabla.Rentas_Devengar Rentas_Devengar,
    tabla.RENTAS_DEVENGAR + ta.RESIDUAL_VALUE Rentas_Devengar_Residual,
    tabla.SALDO_INS_CAPITAL + ta.RESIDUAL_VALUE Riesgo_Expuesto,
    NVL(OCon.Otros_Conceptos, 0) Otros_Conceptos_Vencidos,
    NVL(Venc.Rentas_Vencidas, 0) Total_Exigible
    --nvl(Venc.Saldo_Vencido_Capital, 0)  Total_Exigible
	...
	from imxdb.G_DOSSIER DOSS
		...
		inner join (
            Select MORALPHY, PRENOM, NOMCOMPL, NOM, STR33, GENRE, TVA, REFINDIVIDU--, ADR2
		...
		----------------- GGF 2020-03-10 tablas amortizacion; incluye fecha de facturación para discriminar las facturas anticipadas
		inner join (
